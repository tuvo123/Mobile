        ...
        t = {
            ...
            cart_submit: function(t) {
                var e = n(document.activeElement),
                    ...
                    c = n(t.currentTarget);
                if (0 !== (c = !c.is("form") ? n(t.currentTarget).parents("form") : c).find(".woocommerce-cart-form__contents").length) return !i(c) && void(o.is(':input[name="update_cart"]') || e.is("input.qty") ? (t.preventDefault(), this.quantity_update(c)) : (o.is(':input[name="apply_coupon"]') || e.is("#coupon_code")) && (t.preventDefault(), this.apply_coupon(c)))
            },
