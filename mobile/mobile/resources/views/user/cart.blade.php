...
<section class="cart">
        <div class="container">
            <div class="cart-quay-lai">
                <li><a href="/user/product"><i class='bx bx-chevron-left'></i>Mua thêm sản phẩm khác</a></li>
            ...
            <div class="cart-box">
                ...
                <div class="cart-box-thong-tin-kh">
                    <div class="cart-box-thong-tin-khach-hang">
                        ...
                        <div class="cart-box-radio-btn">
                            <li><input type="radio" id="nam" name="gioitinh">
                            <label for="nam">Anh</label></li>
                            <li><input type="radio" id="nu" name="gioitinh">
                    ...
                    <div class="cart-box-thong-tin-dia-chi">
                        ...
                        <div class="cart-box-radio-btn">
                            <li><input type="radio" id="giaotannoi" name="noinhan">
                            <label for="giaotannoi">Giao tận nơi</label></li>
                            <li><input type="radio" id="nhantaisieuthi" name="noinhan">
                ...
                <div class="cart-box-thanh-toan">
                    <div class="cart-box-giam-gia">
                        ...
                        <li><input type="text" placeholder="Nhập Mã giảm/Phiếu mua hàng"><input type="button" value="Áp dụng"></li>
                    </div>
                    ...
                    <div class="cart-box-button-dat-hang">
                        <a href="/user/pay"><input type="button" value="ĐẶT HÀNG"></a>
                    </div>
