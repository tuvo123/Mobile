            ...
            <div class="thanh-toan-box">
                ...
                <div class="thanh-toan-bottom">
                    <div class="thanh-toan-bottom-loi-co">
                        Cảm ơn Anh <span>Nguyễn Văn A</span> đã cho VATH cơ hội được phục vụ.
                    </div>
                    <div class="thanh-toan-bottom-don-hang">
                        ...
                        <div class="bottom">
                            <li><b>Người nhận hàng: </b>Anh Nguyễn Văn A, 0345353535</li>
                            <li><b>Giao đên: </b>203, Văn Cao, phường Phú Thọ Hòa, quận Tân Phú, Hồ Chí Minh (nhân viên sẽ gọi xác nhận trước khi giao).</li>
                            <li><b>Tổng tiền: </b><span>28.290.000<sup>đ</sup></span></li>
                        </div>
                    </div>
                    ...
                    <div class="thanh-toan-bottom-hinh-thuc-thanh-toan">
                        ...
                        <li><input type="radio" id="tienmat" name="tienmat">
                    ...
                    <div class="thanh-toan-bottom-xac-nhan">
                        <a href="#"><button>XÁC NHẬN</button></a>
                    </div>
                    ...
                    <div class="thanh-toan-bottom-thoi-gian">
                        ...
                        <div class="thong-tin-sp">
                            ...
                            <div class="san-pham">
                                ...
                                <li><div class="tensp">Điện thoại iPhone 15 Pro 128GB</div>
                                    <div class="mau">
                        ...
                        <a class="mau-them-sp" href="/user/product"><div >Mua thêm sản phẩm khác </div></a>
